...
console.log("Subtraction of 2 numbers: " + (4 - 3));
console.log("Multiplication of 4 odd numbers: " + (1 * 3 * 5 * 7));
console.log("Volume of a rectangle:" + (3 * 5 * 7));
let price = 9.99;
let discount = 0.20;
let discountedPrice = 9.99 * (1 - discount);
console.log("Discounted Price:" + discountedPrice);
let x = Math.round(100 / 60);
console.log(x);